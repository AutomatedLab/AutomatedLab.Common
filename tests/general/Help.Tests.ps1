...
Param (
    ...
    [string[]]
    $CommandPath = @("$global:testroot/../AutomatedLab.Common/functions", "$global:testroot/../AutomatedLab.Common/internal/functions"),
...
foreach ($command in $commands)
{
    ...
    Describe "Test help for $commandName" {
        ...
        Context "Test parameter help for $commandName" {
            ...
            $common = 'Debug', 'ErrorAction', 'ErrorVariable', 'InformationAction', 'InformationVariable', 'OutBuffer', 'OutVariable', 'PipelineVariable', 'Verbose', 'WarningAction', 'WarningVariable', 'ProgressAction', 'WhatIf', 'Confirm'
